...
export const RISK_CONFIG = {
  ...
  EURJPY: {
    tpAtr: 0.45, slAtr: 2.60, maxHoldH: 24, reversalEnabled: false,
    spread: 0.018,
    targetLeveragePerTrade: 1.5,
  ...
  GBPJPY: {
    tpAtr: 0.45, slAtr: 1.50, maxHoldH: 24, reversalEnabled: false,
    spread: 0.022,
    targetLeveragePerTrade: 1.5,
  ...
  UK_100: {
    tpAtr: 0.60, slAtr: 1.50, maxHoldH: 24, reversalEnabled: false,
    spread: 2.0,
  ...
  CrudeOIL: {
    tpAtr: 0.40, slAtr: 1.45, maxHoldH: 24, reversalEnabled: true,
    spread: 0.04,
    targetLeveragePerTrade: 0.5,
  ...
  GASOLINE: {
    tpAtr: 0.40, slAtr: 1.45, maxHoldH: 24, reversalEnabled: false,
    spread: 0.003,
    targetLeveragePerTrade: 0.5,
