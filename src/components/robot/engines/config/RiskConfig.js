...
export const RISK_CONFIG = {
  ...
  EURUSD: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.00298, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.00008,
  ...
  AUDUSD: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.00224, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.00008,
    targetLeveragePerTrade: 3.0,
  ...
  USDCHF: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.00240, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.00015,
    targetLeveragePerTrade: 3.0,
  ...
  GBPUSD: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.00319, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.00012,
    targetLeveragePerTrade: 3.0,
  ...
  USDJPY: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.439, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.013,
    targetLeveragePerTrade: 3.0,
  ...
  EURJPY: {
    tpAtr: 0.65, slAtr: 1.75, atrH1Cap: 0.50, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.020,
    targetLeveragePerTrade: 3.0,
  ...
  GBPJPY: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.60, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.030,
    targetLeveragePerTrade: 3.0,
  ...
  AUDJPY: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.40, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.020,
    targetLeveragePerTrade: 3.0,
  ...
  UK_100: {
    tpAtr: 0.50, slAtr: 1.70, atrH1Cap: 43.6, maxHoldH: 96, exhaustionEnabled: true,
    spread: 2.0,
  ...
  GERMANY_40: {
    tpAtr: 0.50, slAtr: 1.75, atrH1Cap: 145.8, maxHoldH: 96, exhaustionEnabled: true,
    spread: 5.0,
    targetLeveragePerTrade: 1.5,
  ...
  FRANCE_40: {
    tpAtr: 0.50, slAtr: 1.65, atrH1Cap: 53.3, maxHoldH: 96, exhaustionEnabled: true,
    spread: 2.0,
    targetLeveragePerTrade: 1.5,
  ...
  US_30: {
    tpAtr: 0.50, slAtr: 1.70, atrH1Cap: 245.0, maxHoldH: 96, exhaustionEnabled: true,
    spread: 7.0,
    targetLeveragePerTrade: 1.5,
  ...
  US_500: {
    tpAtr: 0.50, slAtr: 1.70, atrH1Cap: 36.75, maxHoldH: 96, exhaustionEnabled: true,
    spread: 1.0,
    targetLeveragePerTrade: 1.5,
  ...
  US_TECH100: {
    tpAtr: 0.50, slAtr: 1.70, atrH1Cap: 182.85, maxHoldH: 96, exhaustionEnabled: true,
    spread: 2.25,
    targetLeveragePerTrade: 1.5,
  ...
  JAPAN_225: {
    tpAtr: 0.50, slAtr: 1.70, atrH1Cap: 350, maxHoldH: 96, exhaustionEnabled: true,
    spread: 15.0,
    targetLeveragePerTrade: 1.5,
  ...
  BTCEUR: {
    tpAtr: 0.55, slAtr: 1.75, atrH1Cap: 970.69, maxHoldH: 96, exhaustionEnabled: true,
    spread: 70.71,
  ...
  BTCUSD: {
    tpAtr: 0.55, slAtr: 1.75, atrH1Cap: 1129.82, maxHoldH: 96, exhaustionEnabled: true,
    spread: 51.3,
  ...
  BTCJPY: {
    tpAtr: 0.55, slAtr: 1.75, atrH1Cap: 1100, maxHoldH: 96, exhaustionEnabled: true,
    spread: 5000,
    targetLeveragePerTrade: 0.5,
  ...
  ETHUSD: {
    tpAtr: 0.55, slAtr: 1.75, atrH1Cap: 62.43, maxHoldH: 96, exhaustionEnabled: true,
    spread: 1.9,
    targetLeveragePerTrade: 0.5,
  ...
  GOLD: {
    tpAtr: 0.50, slAtr: 1.80, atrH1Cap: 38.60, maxHoldH: 96, exhaustionEnabled: true,
    spread: 1.26,
  ...
  SILVER: {
    tpAtr: 0.50, slAtr: 1.80, atrH1Cap: 1.653, maxHoldH: 96, exhaustionEnabled: true,
    volume_min: 0.01, volume_max: 100, volume_step: 0.01,
    spread: 0.065,
  ...
  CrudeOIL: {
    tpAtr: 0.50, slAtr: 1.75, atrH1Cap: 1.22, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.04,
  ...
  GASOLINE: {
    tpAtr: 0.50, slAtr: 1.75, atrH1Cap: 0.0441, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.003,
    targetLeveragePerTrade: 0.4,
  ...
  WHEAT: {
    tpAtr: 0.60, slAtr: 1.80, atrH1Cap: 5.50, maxHoldH: 96, exhaustionEnabled: true,
    spread: 1.0, spread_price: 1.0,
    targetLeveragePerTrade: 0.40,
    contractSize: 100, refPrice: 596, baseToEUR: 0.847,
    tickSize: 0.25,
    volume_min: 0.01, volume_max: 100, volume_step: 0.01,
  },
