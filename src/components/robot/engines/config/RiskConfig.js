...
export const RISK_CONFIG = {
  ...
  EURUSD: {
    tpAtr: 0.45, slAtr: 1.80, atrH1Cap: 0.00298, maxHoldH: 24, reversalEnabled: true,
    spread: 0.00008,
  ...
  NZDUSD: {
    tpAtr: 0.45, slAtr: 1.80, atrH1Cap: 0.00186, maxHoldH: 24, reversalEnabled: true,
    spread: 0.00008,
    targetLeveragePerTrade: 3.0,
  ...
  USDCHF: {
    tpAtr: 0.45, slAtr: 1.20, atrH1Cap: 0.00240, maxHoldH: 24, reversalEnabled: true,
    spread: 0.00015,
    targetLeveragePerTrade: 3.0,
  ...
  USDCAD: {
    tpAtr: 0.40, slAtr: 1.20, atrH1Cap: 0.00253, maxHoldH: 24, reversalEnabled: true,
    spread: 0.00015,
    targetLeveragePerTrade: 3.0,
  ...
  USDJPY: {
    tpAtr: 0.45, slAtr: 1.80, atrH1Cap: 0.439, maxHoldH: 24, reversalEnabled: true,
    spread: 0.013,
    targetLeveragePerTrade: 3.0,
  ...
  EURJPY: {
    tpAtr: 0.45, slAtr: 1.80, atrH1Cap: 0.404, maxHoldH: 24, reversalEnabled: true,
    spread: 0.018,
    targetLeveragePerTrade: 3.0,
  ...
  EURAUD: {
    tpAtr: 0.45, slAtr: 1.80, atrH1Cap: 0.00471, maxHoldH: 24, reversalEnabled: true,
    spread: 0.00015,
    targetLeveragePerTrade: 3.0,
  ...
  EURCAD: {
    tpAtr: 0.45, slAtr: 1.80, atrH1Cap: 0.00352, maxHoldH: 24, reversalEnabled: true,
    spread: 0.00018,
    targetLeveragePerTrade: 3.0,
  ...
  EURCHF: {
    tpAtr: 0.45, slAtr: 1.50, atrH1Cap: 0.00172, maxHoldH: 24, reversalEnabled: true,
    spread: 0.00018,
    targetLeveragePerTrade: 3.0,
  ...
  GBPJPY: {
    tpAtr: 0.45, slAtr: 1.80, atrH1Cap: 0.515, maxHoldH: 24, reversalEnabled: true,
    spread: 0.022,
    targetLeveragePerTrade: 3.0,
  ...
  FRANCE_40: {
    tpAtr: 0.45, slAtr: 1.80, atrH1Cap: 53.3, maxHoldH: 24, reversalEnabled: true,
    spread: 2.0,
    targetLeveragePerTrade: 1.0,
  ...
  US_500: {
    tpAtr: 0.45, slAtr: 1.80, atrH1Cap: 36.75, maxHoldH: 24, reversalEnabled: true,
    spread: 1.0,
    targetLeveragePerTrade: 1.0,
  ...
  BTCEUR: {
    tpAtr: 0.45, slAtr: 1.80, atrH1Cap: 970.69, maxHoldH: 24, reversalEnabled: true,
    spread: 70.71,
  ...
  ETHUSD: {
    tpAtr: 0.45, slAtr: 1.80, atrH1Cap: 62.43, maxHoldH: 24, reversalEnabled: true,
    spread: 1.9,
    targetLeveragePerTrade: 0.3,
  ...
  CrudeOIL: {
    tpAtr: 0.35, slAtr: 1.35, atrH1Cap: 1.22, maxHoldH: 24, reversalEnabled: true,
    spread: 0.04,
    targetLeveragePerTrade: 0.5,
  ...
  GASOLINE: {
    tpAtr: 0.25, slAtr: 1.50, atrH1Cap: 0.0441, maxHoldH: 24, reversalEnabled: true,
    spread: 0.003,
    targetLeveragePerTrade: 0.5,
