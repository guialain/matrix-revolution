...
export const RISK_CONFIG = {
  ...
  EURUSD: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.00298, maxHoldH: 96, reversalEnabled: true,
    spread: 0.00008,
  ...
  AUDUSD: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.00224, maxHoldH: 96, reversalEnabled: true,
    spread: 0.00008,
    targetLeveragePerTrade: 3.0,
  ...
  USDCHF: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.00240, maxHoldH: 96, reversalEnabled: true,
    spread: 0.00015,
    targetLeveragePerTrade: 3.0,
  ...
  GBPUSD: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.00319, maxHoldH: 96, reversalEnabled: true,
    spread: 0.00012,
    targetLeveragePerTrade: 3.0,
  ...
  USDJPY: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.439, maxHoldH: 96, reversalEnabled: true,
    spread: 0.013,
    targetLeveragePerTrade: 3.0,
  ...
  GBPJPY: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.60, maxHoldH: 96, reversalEnabled: true,
    spread: 0.030,
    targetLeveragePerTrade: 3.0,
  ...
  AUDJPY: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 0.40, maxHoldH: 96, reversalEnabled: true,
    spread: 0.020,
    targetLeveragePerTrade: 3.0,
  ...
  GERMANY_40: {
    tpAtr: 0.50, slAtr: 1.75, atrH1Cap: 145.8, maxHoldH: 96, reversalEnabled: true,
    spread: 5.0,
    targetLeveragePerTrade: 1.5,
  ...
  SILVER: {
    tpAtr: 0.50, slAtr: 1.80, atrH1Cap: 1.653, maxHoldH: 96, reversalEnabled: true,
    volume_min: 0.01, volume_max: 100, volume_step: 0.01,
    spread: 0.065,
  ...
  CrudeOIL: {
    tpAtr: 0.50, slAtr: 1.75, atrH1Cap: 1.22, maxHoldH: 96, reversalEnabled: true,
    spread: 0.04,
  ...
  GASOLINE: {
    tpAtr: 0.50, slAtr: 1.75, atrH1Cap: 0.0441, maxHoldH: 96, reversalEnabled: true,
    spread: 0.003,
    targetLeveragePerTrade: 0.4,
  ...
  WHEAT: {
    tpAtr: 0.60, slAtr: 1.80, atrH1Cap: 5.50, maxHoldH: 96, reversalEnabled: true,
