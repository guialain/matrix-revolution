...
export const RISK_CONFIG = {
  ...
  GERMANY_40: {
    tpAtr: 0.50, slAtr: 1.70, atrH1Cap: 145.8, maxHoldH: 96, reversalEnabled: true,
    spread: 5.0,
    targetLeveragePerTrade: 1.0,
  ...
  FRANCE_40: {
    tpAtr: 0.50, slAtr: 1.70, atrH1Cap: 53.3, maxHoldH: 96, reversalEnabled: true,
    spread: 2.0,
    targetLeveragePerTrade: 1.0,
  ...
  BTCEUR: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 970.69, maxHoldH: 96, reversalEnabled: true,
    spread: 70.71,
  ...
  BTCUSD: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 1129.82, maxHoldH: 96, reversalEnabled: true,
    spread: 51.3,
    targetLeveragePerTrade: 0.3,
  ...
  BTCJPY: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 1100, maxHoldH: 96, reversalEnabled: true,
    spread: 5000,
    targetLeveragePerTrade: 0.3,
  ...
  ETHUSD: {
    tpAtr: 0.55, slAtr: 1.65, atrH1Cap: 62.43, maxHoldH: 96, reversalEnabled: true,
    spread: 1.9,
    targetLeveragePerTrade: 0.3,
  ...
  WHEAT: {
    tpAtr: 0.60, slAtr: 1.98, atrH1Cap: 5.50, maxHoldH: 96, reversalEnabled: true,
