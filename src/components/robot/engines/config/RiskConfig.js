...
//
// ✅ TP/SL en zscore (sigma_h1 based) — voir computeSLTP dans DealingRoom.jsx
//    et useAutoTrader.js. SL = ±1.5σ, TP = ±0.5σ (ratio 1:3).
//
//   atrH1Cap : cap ATR H1 (encore utilise pour gate volatilite extreme amont).
//
...
export const RISK_CONFIG = {
  ...
  EURUSD: {
    atrH1Cap: 0.00298, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.00008,
  ...
  AUDUSD: {
    atrH1Cap: 0.00224, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.00008,
    targetLeveragePerTrade: 3.0,
  ...
  USDCHF: {
    atrH1Cap: 0.00240, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.00015,
    targetLeveragePerTrade: 3.0,
  ...
  USDJPY: {
    atrH1Cap: 0.439, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.013,
    targetLeveragePerTrade: 3.0,
  ...
  EURJPY: {
    atrH1Cap: 0.50, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.020,
    targetLeveragePerTrade: 3.0,
  ...
  GBPJPY: {
    atrH1Cap: 0.60, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.030,
    targetLeveragePerTrade: 3.0,
  ...
  AUDJPY: {
    atrH1Cap: 0.40, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.020,
    targetLeveragePerTrade: 3.0,
  ...
  UK_100: {
    atrH1Cap: 43.6, maxHoldH: 96, exhaustionEnabled: true,
    spread: 2.0,
  ...
  GERMANY_40: {
    atrH1Cap: 145.8, maxHoldH: 96, exhaustionEnabled: true,
    spread: 5.0,
    targetLeveragePerTrade: 1.5,
  ...
  FRANCE_40: {
    atrH1Cap: 53.3, maxHoldH: 96, exhaustionEnabled: true,
    spread: 2.0,
    targetLeveragePerTrade: 1.5,
  ...
  US_30: {
    atrH1Cap: 245.0, maxHoldH: 96, exhaustionEnabled: true,
    spread: 7.0,
    targetLeveragePerTrade: 1.5,
  ...
  US_500: {
    atrH1Cap: 36.75, maxHoldH: 96, exhaustionEnabled: true,
    spread: 1.0,
    targetLeveragePerTrade: 1.5,
  ...
  US_TECH100: {
    atrH1Cap: 182.85, maxHoldH: 96, exhaustionEnabled: true,
    spread: 2.25,
    targetLeveragePerTrade: 1.5,
  ...
  JAPAN_225: {
    atrH1Cap: 350, maxHoldH: 96, exhaustionEnabled: true,
    spread: 15.0,
    targetLeveragePerTrade: 1.5,
  ...
  BTCEUR: {
    atrH1Cap: 970.69, maxHoldH: 96, exhaustionEnabled: true,
    spread: 70.71,
  ...
  BTCUSD: {
    atrH1Cap: 1129.82, maxHoldH: 96, exhaustionEnabled: true,
    spread: 51.3,
  ...
  ETHUSD: {
    atrH1Cap: 62.43, maxHoldH: 96, exhaustionEnabled: true,
    spread: 1.9,
    targetLeveragePerTrade: 0.5,
  ...
  GOLD: {
    atrH1Cap: 38.60, maxHoldH: 96, exhaustionEnabled: true,
    spread: 1.26,
  ...
  SILVER: {
    atrH1Cap: 1.653, maxHoldH: 96, exhaustionEnabled: true,
    volume_min: 0.01, volume_max: 100, volume_step: 0.01,
    spread: 0.065,
  ...
  CrudeOIL: {
    atrH1Cap: 1.22, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.04,
  ...
  GASOLINE: {
    atrH1Cap: 0.0441, maxHoldH: 96, exhaustionEnabled: true,
    spread: 0.003,
    targetLeveragePerTrade: 0.4,
  ...
  WHEAT: {
    atrH1Cap: 5.50, maxHoldH: 96, exhaustionEnabled: true,
