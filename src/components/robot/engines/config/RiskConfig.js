...
export const RISK_CONFIG = {
  ...
  EURUSD: {
    tpAtr: 0.60, slAtr: 1.75, maxHoldH: 8, reversalEnabled: true,
    spread: 0.00008,
  ...
  USDCHF: {
    tpAtr: 0.50, slAtr: 1.40, maxHoldH: 8, reversalEnabled: true,
    spread: 0.00015,
    targetLeveragePerTrade: 1.5,
  ...
  USDCAD: {
    tpAtr: 0.45, slAtr: 1.45, maxHoldH: 8, reversalEnabled: true,
    spread: 0.00015,
    targetLeveragePerTrade: 1.5,
  ...
  EURJPY: {
    tpAtr: 0.45, slAtr: 2.60, maxHoldH: 8, reversalEnabled: false,
    spread: 0.018,
    targetLeveragePerTrade: 1.5,
  ...
  GBPJPY: {
    tpAtr: 0.45, slAtr: 1.50, maxHoldH: 8, reversalEnabled: false,
    spread: 0.022,
    targetLeveragePerTrade: 1.5,
  ...
  UK_100: {
    tpAtr: 0.60, slAtr: 1.50, maxHoldH: 4.05, reversalEnabled: false,
    spread: 2.0,
  ...
  BTCEUR: {
    tpAtr: 0.45, slAtr: 1.45, maxHoldH: 4.0, reversalEnabled: true,
    spread: 70.71,
  ...
  BTCUSD: {
    tpAtr: 0.45, slAtr: 1.65, maxHoldH: 4.0, reversalEnabled: false,
    spread: 51.3,
    targetLeveragePerTrade: 0.3,
  ...
  ETHUSD: {
    tpAtr: 0.35, slAtr: 1.5, maxHoldH: 4.0, reversalEnabled: true,
    spread: 1.9,
  ...
  GOLD: {
    tpAtr: 0.50, slAtr: 1.0, maxHoldH: 4.0, reversalEnabled: true,
    spread: 1.26,
    targetLeveragePerTrade: 1.0,
  ...
  SILVER: {
    tpAtr: 0.55, slAtr: 2.85, maxHoldH: 4.0, reversalEnabled: true,
    volume_min: 0.01, volume_max: 100, volume_step: 0.01,
    spread: 0.148,
    targetLeveragePerTrade: 0.5,
