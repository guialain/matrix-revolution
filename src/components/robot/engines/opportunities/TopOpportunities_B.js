// ============================================================================
// TopOpportunities_B.js — 12-ROUTE MATCHER v8B (EXPERIMENTAL)
// Clone de TopOpportunities.js v8 avec seuils relâchés pour plus de volume
//
// Différences vs v8:
//   - slope_h1 continuation: 0.5 / 1.0 / 1.5 (was 1.0 / 1.5 / 2.0)
//   - drsi_h1 continuation: 0.5 (was 1.0)
...
// ============================================================================
// 12-ROUTE MATCHER (v8B — relaxed thresholds)
// ============================================================================
...
// ============================================================================
export function evaluateTopOpportunities_B(marketData = []) {
