...
const TopOpportunities_V8R = (() => {
  ...
  function getH1Conditions(side, mode, type) {
    ...
    if (type === 'CONTINUATION' && side === 'BUY') {
      ...
      if (mode === 'soft')    return { h1_s0_min: 'flat',      h1_s0_max: null, h1_dslope_min: -1.5, h1_dslope_max: 6.0,  h1_dslope_min_v_shape: null, h1_dslope_max_v_shape: 8,  zscoreCap: 2.0,  zscoreFloor: null };
      if (mode === 'relaxed') return { h1_s0_min: 'down_weak', h1_s0_max: null, h1_dslope_min: -3.3, h1_dslope_max: 8.0,  h1_dslope_min_v_shape: null, h1_dslope_max_v_shape: 10, zscoreCap: 2.5,  zscoreFloor: null };
    }
    ...
    if (type === 'CONTINUATION' && side === 'SELL') {
      ...
      if (mode === 'soft')    return { h1_s0_min: null, h1_s0_max: 'flat',      h1_dslope_min: -6.0, h1_dslope_max: 1.5,  h1_dslope_min_v_shape: -8,  h1_dslope_max_v_shape: null, zscoreCap: null, zscoreFloor: -2.0 };
      if (mode === 'relaxed') return { h1_s0_min: null, h1_s0_max: 'up_weak',   h1_dslope_min: -8.0, h1_dslope_max: 3.3,  h1_dslope_min_v_shape: -10, h1_dslope_max_v_shape: null, zscoreCap: null, zscoreFloor: -2.5 };
    }
