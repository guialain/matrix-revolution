...
const TopOpportunities_V8R = (() => {
  ...
  function getH1Conditions(side, mode, type) {
    ...
    if (type === 'CONTINUATION' && side === 'BUY') {
      if (mode === 'strict')  return { h1_s0_min: 'up_weak',   h1_s0_max: null, h1_dslope_min: 2.5,  h1_dslope_max: 4.0,  h1_dslope_min_v_shape: null, h1_dslope_max_v_shape: 5,  zscoreCap: 1.75, zscoreFloor: null };
      if (mode === 'normal')  return { h1_s0_min: 'up_weak',   h1_s0_max: null, h1_dslope_min: 1.5,  h1_dslope_max: 5.0,  h1_dslope_min_v_shape: null, h1_dslope_max_v_shape: 6,  zscoreCap: 2.0,  zscoreFloor: null };
    ...
    if (type === 'CONTINUATION' && side === 'SELL') {
      if (mode === 'strict')  return { h1_s0_min: null, h1_s0_max: 'down_weak', h1_dslope_min: -4.0, h1_dslope_max: -2.5, h1_dslope_min_v_shape: -5,  h1_dslope_max_v_shape: null, zscoreCap: null, zscoreFloor: -1.75 };
      if (mode === 'normal')  return { h1_s0_min: null, h1_s0_max: 'down_weak', h1_dslope_min: -5.0, h1_dslope_max: -1.5, h1_dslope_min_v_shape: -6,  h1_dslope_max_v_shape: null, zscoreCap: null, zscoreFloor: -2.0 };
